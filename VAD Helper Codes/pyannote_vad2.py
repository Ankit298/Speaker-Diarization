...
def ground_truth(frame_duration_ms,annotation_path):
...
def predict(frame_duration_ms,frames,path,gt_list):
    OWN_FILE = {'audio': path}
...
def main():
    ...
    for file in sound_files:
      ...
      frames = list(frames)
      gt_list = ground_truth(30,annotation_path)
      pred_list = predict(30,frames,data_path,gt_list)
      gt_length = len(gt_list)
      print("Length of gt: " + str(gt_length))
      print("Length of pred_list:" +str(len(pred_list)))
    ...
    result_df.to_csv('/home/an46/tmp_pyannote/Results/pyannote_new_tl1.csv')
...
# eer_audioband_tl, eer_watch_tl = main()
